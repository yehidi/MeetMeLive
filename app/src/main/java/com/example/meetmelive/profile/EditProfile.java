...
public class EditProfile extends Fragment implements RadioGroup.OnCheckedChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        currentUser = new User(User.getInstance().getSex(), User.getInstance().getPreferSex(), User.getInstance().getUser_id(), User.getInstance().getEmail(),
                User.getInstance().getUsername(), User.getInstance().getCity(), User.getInstance().getDescription(), User.getInstance().getDateOfBirth(),
                User.getInstance().getProfileImageUrl(), User.getInstance().getPic1(), User.getInstance().getPic2(), User.getInstance().getPic3());
        ...
        if(User.getInstance().getPreferSex().equals("Male")){
            radioGroupLookingFor.check(R.id.editProfile_male_radiobutton);
        }
        if(User.getInstance().getPreferSex().equals("Female")){
    ...
    private void updateUserProfile() {
        ...
        getImageFromFireBase("pic3");
        getImageFromFireBase("profileImageUrl");
        Log.d("user p[hoto","pic 1 "+User.getInstance().getPic1());
        Log.d("user p[hoto","pic 1 "+User.getInstance().getProfileImageUrl());
        currentUser = new User(User.getInstance().getSex(), User.getInstance().getPreferSex(), User.getInstance().getUser_id(), User.getInstance().getEmail(),
                User.getInstance().getUsername(), User.getInstance().getCity(), User.getInstance().getDescription(), User.getInstance().getDateOfBirth(),
                User.getInstance().getProfileImageUrl(), User.getInstance().getPic1(), User.getInstance().getPic2(), User.getInstance().getPic3());
